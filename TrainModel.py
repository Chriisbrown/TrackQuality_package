...
NoDegredation.load_data("Datasets/NoDegredation/NoDegredation_Train/")
NoDegredation.train()#
...
NoDegredation.load_data("Datasets/NoDegredation/NoDegredation_Zp/")
NoDegredation.test()
NoDegredation.evaluate(plot=True,save_dir="Projects/NoDegredation/Plots/",name="Zp")
...
plot_ROC_bins([calculate_ROC_bins(NoDegredation.DataSet,NoDegredation.y_predict_proba,variable="trk_eta",var_range=[-2.4,2.4],n_bins=20)],
               ["No Degradation"],"Projects/NoDegredation/",variable="trk_eta",var_range=[-2.4,2.4],n_bins=20,typesetvar="Track $\\eta$")

...
class TrackClassifierModel:
    ...
    @classmethod
    def load_from_pkl(self,model_filename,data_filename):
...
class XGBoostClassifierModel(GBDTClassifierModel):
    ...
    def synth_model(self,sim : bool = True,hdl : bool = True,hls : bool = True,test_events : int = 1000):
        ...
        if sim:
            ...
            simmodel = conifer.model(self.model.get_booster(), conifer.converters.xgboost, conifer.backends.vhdl, simcfg)
            simmodel.compile()
...
class FullXGBoostClassifierModel(XGBoostClassifierModel):
    ...
    def synth_model(self,sim : bool = True,hdl : bool = True,hls : bool = True,test_events : int = 1000):
        ...
        if sim:
            ...
            simmodel = conifer.model(self.model, conifer.converters.xgboost, conifer.backends.vhdl, simcfg)
            simmodel.compile()
